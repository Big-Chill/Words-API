...
class ApiKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_key" do
    assert_difference("ApiKey.count") do
      post api_keys_url, params: { api_key: { api_key: @api_key.api_key, frequency: @api_key.frequency } }
    end
  ...
  test "should update api_key" do
    patch api_key_url(@api_key), params: { api_key: { api_key: @api_key.api_key, frequency: @api_key.frequency } }
